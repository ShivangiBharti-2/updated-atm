...
{ 
    ...
    SignUpThree(String formno)
    {
     ...
     JLabel next = new JLabel("Account Type");
     next.setFont(new Font("Railway" ,Font.BOLD, 22));
     next.setBounds(100,130,400,40);
     add(next);
     ...
     JLabel number = new JLabel("XXXX-XXXX-XXXX-6492");
     ...
     c7 = new JCheckBox("I hereby declares that the line above entered details are correct to the best of my knowledge");
        ...
        { 
            ...
            try{
                if(saccountType.equals(""))
                {
                    ...
                    String query2 = "insert into log values('"+formno+"','"+scardnumber+"','"+spinnumber+"')";
